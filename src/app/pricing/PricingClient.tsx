  ...
  return (
    <div className={`container-app py-16 ${mounted ? 'animate-slide-up' : 'opacity-0'}`}>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {Object.entries(SUBSCRIPTION_PLANS).map(([key, plan]: any, i) => (
          <div key={key} className={`card p-8 relative hover-lift ${i === 0 ? 'animate-slide-left' : 'animate-slide-right'} opacity-0 ${plan.popular ? 'border-primary-500 border-2 shadow-xl scale-[1.02]' : ''}`}>
            {plan.popular && (
